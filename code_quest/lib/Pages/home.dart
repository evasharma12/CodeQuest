  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          "Home", style: TextStyle(color: Colors.cyan[400]),
      ...
      body: SingleChildScrollView(
        child: Column(
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text('\n\n\"Any fool can write code that a computer can understand. Good programmers write code that humans can understand.\"', style: TextStyle(color: Colors.white, fontSize: 15),),
                  Text('\n-Martin Fowler', style: TextStyle(fontStyle: FontStyle.italic, fontSize: 12, color: Colors.cyan[500]),)
                ],
              ),
              ),
